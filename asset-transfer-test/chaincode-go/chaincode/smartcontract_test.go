...
func TestCreateAsset(t *testing.T) {
	...
	err = assetTransfer.CreateAsset(transactionContext, "000001", 10, "Salvatore", "Mirko", 90)
	require.EqualError(t, err, "the asset 000001 already exists")
...
func TestReadAsset(t *testing.T) {
	...
	expectedAsset := &chaincode.Asset{ID: "000001"}
	...
	asset, err = assetTransfer.ReadAsset(transactionContext, "000001")
	require.EqualError(t, err, "the asset 000001 does not exist")
	require.Nil(t, asset)
}
...
func TestUpdateAsset(t *testing.T) {
	...
	chaincodeStub.GetStateReturns(bytes, nil)
	assetTransfer := chaincode.SmartContract{}
	err = assetTransfer.UpdateAsset(transactionContext, "000001", 10, "Salvatore", "Mirko", 90)
	require.NoError(t, err)
...
func TestDeleteAsset(t *testing.T) {
	...
	asset := &chaincode.Asset{ID: "000001"}
	...
	chaincodeStub.GetStateReturns(nil, nil)
	err = assetTransfer.DeleteAsset(transactionContext, "000001")
	require.EqualError(t, err, "the asset 000001 does not exist")
